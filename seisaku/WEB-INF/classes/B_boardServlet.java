...
public class B_boardServlet extends HttpServlet{
    public void doPost(HttpServletRequest req,HttpServletResponse res)
		...
		//jsp��name�ɓ����
        	String title=cn.conversionText(req.getParameter("title"));
        	String name=cn.conversionText(req.getParameter("name"));
        	String body=cn.conversionText(req.getParameter("body"));
